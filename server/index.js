...
const io = new Server(httpServer, {
    ...
    allowUpgrades:true,
    cors: {
        origin: ['https://assassination-react.herokuapp.com', 'http://localhost:3000']
    },
    serveClient: true,
    allowEIO3: true,
});
...
async function startApolloServer(typeDefs, resolvers) {
    const server = new ApolloServer({
        ...
        csrfPrevention: true,
        cors: {
            origin: ['https://assassination-react.herokuapp.com','http://localhost:3000',"https://studio.apollographql.com", "https://assassination-v2.herokuapp.com/"]
        },
